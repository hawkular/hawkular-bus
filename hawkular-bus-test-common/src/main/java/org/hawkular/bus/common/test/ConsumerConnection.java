...
/**
 * Convenience class tests can use to create a consumer of either topic or queue messages from a broker.
 *
 * The constructor creates the connection and attaches the listener after which the listener can start consuming
